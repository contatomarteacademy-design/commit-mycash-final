    ...
    <>
      <Dialog.Root open={open} onOpenChange={setOpen}>
        <Dialog.Trigger asChild>
          <button className="flex items-center gap-2 px-6 py-4 bg-foreground text-white rounded-full hover:bg-gray-800 transition-colors">
            <span className="text-lg font-semibold">Nova transação</span>
          </button>
        </Dialog.Trigger>
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-card rounded-2xl p-8 z-50 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    aria-label="Tipo de transação: Receita"
                  >
                  ...
                  <button
                    ...
                    aria-label="Tipo de transação: Despesa"
                  >
              ...
              <div>
                ...
                />
                <p id="description-help" className="text-xs text-gray-500 mt-1">Mínimo de 3 caracteres</p>
              </div>

              {/* Category */}
              <div>
                <label htmlFor="category" className="block text-sm font-semibold mb-2">Categoria</label>
                <select
                  id="category"
              ...
              <div>
                <label className="block text-sm font-semibold mb-2">
                  Membro Responsável <span className="text-gray-400 text-xs">(opcional)</span>
                </label>
                <select
                  ...
                  className="w-full px-4 py-3 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-lime"
                >
                  <option value="">Todos (Familiar)</option>
                  {members.map((member) => (
